...
<div class="row main">
            ...
            <div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="taskTitle" id="taskTitle"  placeholder="@lang('Task/create.taskTitle')"/>
</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<textarea class="form-control" name="taskDescription" id="taskDescription"  placeholder="@lang('Task/create.taskDescription')"/></textarea>
								</div>
            ...
            <div class="form-group">
							<label for="taskFile" class="cols-sm-2 control-label">@lang('Task/create.taskFile')</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
									<input type="file" class="form-control" name="taskFile" id="taskFile"  placeholder="@lang('Task/create.taskFile')"/>
								</div>
							</div>
						</div>
